...
class Ui_ACOGui(object):
    def setupUi(self, ACOGui):
        ...
        self.rhoSpin.setProperty("value", 0.005)
        self.rhoSpin.setObjectName(_fromUtf8("rhoSpin"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.rhoSpin)
        ...
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.antNumSpin)
